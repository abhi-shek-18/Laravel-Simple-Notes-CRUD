...
<div class="card mt-5">
    <h2 class="card-header">Update <?php echo e($note->title); ?> Note</h2>
    <div class="card-body">
...
unset($__errorArgs, $__bag); ?>"  id="inputTitle" 
            placeholder="Title" value="<?php echo e($note->title); ?>">
...
unset($__errorArgs, $__bag); ?>"  id="inputContent" 
            placeholder="content" value="<?php echo e($note->content); ?>">
